...
function Contactus() {
  ...
  <div class=" px-5 py-10 mx-auto flex sm:flex-nowrap flex-wrap mr-10"><img class="lg:w-1/2 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end  relative" src='https://www.pngitem.com/pimgs/m/586-5864602_design-photography-logo-camera-png-transparent-png.png' alt='camera'></img>
    <div >
    ...
    <div className=' rounded border text-left py-10 px-20'>
      <div class="relative mb-4">
        <h2 class="text-blue-500 text-2xl mb-7 font-medium  text-center title-font">Contact US</h2>
        <label for="name" class="leading-7 text-left text-gray-600 ">Name</label>
      ...
      <div class="relative mb-4">
        <label for="email" class="leading-7 text text-gray-600">Email</label>
      ...
      <div class="relative mb-4">
        <label for="Select Area" class="leading-7 text text-gray-600">Select Area</label>
        <input type="text" id="Select Area" name="Select Area" class="w-full bg-white rounded border border-gray-300 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"/>
      </div>
      <div class="relative mb-4">
      ...
      <button class="text-white text bg-blue-500 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded text-lg">Button</button>
      </div>
      </div>
    </div>
  </div>
